...
class ConversionViewController: UIViewController, UITextFieldDelegate {
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        ...
        let existingTextHasDecimalSeparator = textField.text?.range(of: ".") // Question mark means it's string optional- if there's a dot it'll return nil
        let replacementTextHasDecimalSeparator = string.range(of: ".") // Will return nil when there's no dot there
